...
`;
const MentionDropper = ({ show, onCloseModal, register, onClickOption }: IProps) => {
  if (!show) return null;

  return (
    <PrevModalContent title={'친구 검색'} show={show} onCloseModal={onCloseModal}>
      <Base>
